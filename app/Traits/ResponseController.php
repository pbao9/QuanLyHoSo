...
trait ResponseController
{
     ...
     * @return RedirectResponse
     */
    public function handleUpdateResponse(mixed $response, string $editRoute): RedirectResponse
    {
        if ($response) {
            return to_route($editRoute, ['id' => $response->id])->with('success', __('notifySuccess'));
        }
     ...
     * @return RedirectResponse
     */
    public function handleDeleteResponse(mixed $response, string $indexRoute): RedirectResponse
    {
        if ($response) {
            return to_route($indexRoute)->with('success', __('notifySuccess'));
        }
